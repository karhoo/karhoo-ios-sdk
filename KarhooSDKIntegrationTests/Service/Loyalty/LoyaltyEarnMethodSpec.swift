...
final class LoyaltyEarnMethodSpec: XCTestCase {

    private var loyaltyService: LoyaltyService!
    private let path = "/v1/loyalty-someid/exrates/EUR/earnpoints?total_amount=1000&burn_points=500"
    ...
    override func setUp() {
        ...
        call = loyaltyService.getLoyaltyEarn(identifier: "id", currency: "EUR", amount: 1000, points: 500)
    }
